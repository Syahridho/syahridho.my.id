    ...
    <div id="home" className="w-full overflow-auto lg:snap-none lg:pt-10">
      <div className="p-8">
        ...
        <p className="text-slate-600 text-base leading-7">
          ...
          different types of websites, from eye-catching looks to sophisticated
          functionality. I believe that every project is an opportunity to
          combine creativity with the latest technology.
        </p>
      </div>
